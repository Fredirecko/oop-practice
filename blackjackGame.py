...
class Card:
    ...
    def show(self):
        """ 
            ============ Title ============
           displays suit and value of cards 
           ============ End ===============
        """
...
"""
    ...
    def start_game(self):
        ...
        while True:
            ...
            if self.player.get_hand_value() > 21:
                print("\nThe total value of yoru hand is over 21")
                break
        ...
        if player_hand > 21:
            print(f"\nYou lose, {self.player.name}. But dont' worry, you can try again.")
        elif dealer_hand > 21 or player_hand == 21 or player_hand > dealer_hand:
            print(f"\nYou win, {self.player.name}! Congratulations.")
        elif player_hand < dealer_hand:
            print(f"\nYou lose, {self.player.name}. But don't worry, you can try again.")
        else:
            print("We have a tie.")
    ...
    def ask_choice(self):
        ...
        if choice == 1 or choice == 2:
            ...
            print("The value was not valid. I will assume that you chose Stand.")
            return 2
